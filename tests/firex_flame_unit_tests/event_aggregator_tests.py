...
class EventAggregatorTests(unittest.TestCase):
    ...
    def test_merge_flame_data(self):
        ...
        self.assertEqual(
            {event1["uuid"]: {"flame_data": expected_final_flame_data}}, changed_data
        )
        self.assertEqual(
    ...
    def test_aggregate_states(self):
        ...
        aggregated_states = aggregator._tasks_by_uuid[event1["uuid"]].get_field(
            "states"
        )
        expected_states = [
            _to_expected_task({"state": e["type"], "timestamp": e["local_received"]})
            for e in events
        ]
    ...
    def test_aggregate_non_celery_field(self):
        ...
        self.assertEqual(
            "some_url",
            aggregator._tasks_by_uuid[basic_event["uuid"]].get_field("logs_url"),
        )
            ...
            [
                {
                    ...
                    "sw_ver": "9.9.9",
                    "sw_sys": "Linux",
                    "timestamp": 1670605159.61279,
                    "type": "worker-heartbeat",
                    "local_received": 1670605159.613447,
                },
                {
                ...
                },
                {
                    ...
                    "pid": 44987,
                    "clock": 1,
                    "uuid": "b954db0d-e308-4cd4-bcd9-dbbed3982067",
                    "timestamp": 1670605164.6242092,
                    "type": "task-started-info",
                    "local_received": 1670605164.6256702,
                },
                {
                    "uuid": "92b47986-7c9e-47b8-8949-bf3c047fd726",
                    "timestamp": 1670605164.6301577,
                    "type": "task-started-info",
                    "local_received": 1670605164.6447308,
                },
                {
                    "uuid": "b954db0d-e308-4cd4-bcd9-dbbed3982067",
                    "timestamp": 1670605164.6375537,
                    "type": "task-send-flame",
                    "flame_data": flame_data,
                    "local_received": 1670605164.646939,
                },
            ]
        )
