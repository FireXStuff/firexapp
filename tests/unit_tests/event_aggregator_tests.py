...
class EventAggregatorTests(unittest.TestCase):
    def test_add_new_task(self):
        ...
        self.assertEqual(
            {expected_task["uuid"]: expected_task}, aggregator.tasks_by_uuid
        )
    ...
    def test_states_aggregated(self):
        ...
        self.assertEqual(
            expected_states, aggregator.tasks_by_uuid[basic_event["uuid"]]["states"]
        )
    ...
    def test_aggregate_states(self):
        ...
        expected_states = [
            {"state": e["type"], "timestamp": e["local_received"]} for e in events
        ]
