...
firex_run_metadata = Table(
    ...
    metadata,
    Column(
        RunMetadataColumn.FIREX_ID.value, String(50), primary_key=True, nullable=False
    ),
...
COLS_TO_SQLALCHEMY_CONFIG = {
    ...
    TaskColumn.FIREX_ID: {
        "kwargs": {"type_": None},
        "args": [ForeignKey("firex_run_metadata.firex_id")],
    },
    ...
    TaskColumn.EXCEPTION_CAUSE_UUID: {
        "kwargs": {"type_": String(UUID_LEN), "default": None}
    },
}
