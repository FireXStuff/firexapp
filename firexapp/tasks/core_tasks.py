...
# noinspection PyPep8Naming
@app.task(bind=True, returns=FireXTask.DYNAMIC_RETURN)
def ScheduleSubChain(self: FireXTask, chain, chain_args: dict = {}, catch_errors: bool = False):
    """
    ...
    :chain_args: Args to propagate to the enqueue call
    ...
    try:
        results = self.enqueue_child_and_get_results(chain, **chain_args)
